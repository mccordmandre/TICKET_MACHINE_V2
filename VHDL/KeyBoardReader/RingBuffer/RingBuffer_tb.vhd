...
component RingBuffer is
 port(
  ...
  signal Wreg_tb : std_logic_vector(3 downto 0);
  signal DAC_tb : std_logic_vector(3 downto 0);
  signal Q_tb : std_logic_vector(3 downto 0);
  

begin 
UUT: RingBuffer port map ( Kscan => Kscan_tb , CLK => CLK_tb, Reset => Reset_tb, L => L_tb, C => C_tb, K => K_tb, Kpress => Kpress_tb);
